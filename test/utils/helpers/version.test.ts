...
import type {
  ...
  SemVer,
  Versions,
} from '../../../src/utils/helpers/version';
...
describe('version', () => {
  describe('versionMatch', () => {
    it.each([
      ...
      [
        '1.7.3' as SemVer,
        fromPartial<Versions>({ minVersion: '1.7.0', maxVersion: '1.8.0' }),
        true,
      ],
      [
        '1.8.3' as SemVer,
        fromPartial<Versions>({ minVersion: '2.0.0' }),
        false,
      ],
      [
        '1.8.3' as SemVer,
        fromPartial<Versions>({ maxVersion: '1.8.0' }),
        false,
      ],
      [
        '1.8.3' as SemVer,
      ...
      'properly matches versions based on what is provided',
      (version, versionConstraints, expected) => {
